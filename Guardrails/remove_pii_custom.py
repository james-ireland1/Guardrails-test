...
import create_remove_pii_guardrail
...
def remove_pii(text, pii_types=None):
    ...
    if len(pii_types) == 0:
        ...
        guardrail_id, guardrail_version = create_remove_pii_guardrail.create_guardrail('remove-pii-custom',pii_types)
    apply_guardrail(text, guardrail_id, guardrail_version)
